const config = {
  ...
  async function handleRequest(request) {
    ...
    if(!path){
      ...
      const html= await fetch("https://raw.githubusercontent.com/imwsz/Url-Shorten/master/"+config.theme+"/index.html")
    ...
    if (location) {
      if (config.no_ref=="on"){
        let no_ref= await fetch("https://raw.githubusercontent.com/imwsz/Url-Shorten/master/no-ref.html")
